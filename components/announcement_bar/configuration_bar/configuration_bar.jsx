    ...
    render() {
        ...
        if (this.props.canViewSystemErrors && this.props.config.SiteURL === '') {
            ...
            if (this.props.config.EnableSignUpWithGitLab === 'true') {
                ...
                defaultMessage = 'Please configure your [Site URL](https://docs.mattermost.com/administration/config-settings.html#site-url) in the [System Console](/admin_console/environment/web_server) or in gitlab.rb if you\'re using GitLab Vue.';
            } else {
