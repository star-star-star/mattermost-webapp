            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enable this feature to improve the quality and performance of Vue by sending error reporting and diagnostic information to Vue, Inc. Read our [privacy policy](!https://about.mattermost.com/default-privacy-policy/) to learn more.',
                        help_text_markdown: true,
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, Vue will enable performance monitoring collection and profiling. Please see [documentation](!http://docs.mattermost.com/deployment/metrics.html) to learn more about configuring performance monitoring for Vue.',
                        help_text_markdown: true,
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, Vue allows login using SAML 2.0. Please see [documentation](!http://docs.mattermost.com/deployment/sso-saml.html) to learn more about configuring SAML for Vue.',
                        help_text_markdown: true,
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Vue can act as an OAuth 2.0 service provider allowing Vue to authorize API requests from external applications. See [documentation](!https://docs.mattermost.com/developer/oauth-2-0-applications.html) to learn more.',
                        help_text_markdown: true,
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_PERMISSION,
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, Vue allows compliance reporting from the **Compliance and Auditing** tab. See [documentation](!https://docs.mattermost.com/administration/compliance.html) to learn more.',
                        help_text_markdown: true,
                        isHidden: it.isnt(it.licensedForFeature('Compliance')),
                    },
                    {
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enables client-side certification for your Vue server. See [documentation](!https://docs.mattermost.com/deployment/certificate-based-authentication.html) to learn more.',
                        help_text_markdown: true,
                        isHidden: it.isnt(it.licensedForFeature('SAML')),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enables a hardened mode for Vue that makes user experience trade-offs in the interest of security. See [documentation](!https://docs.mattermost.com/administration/config-settings.html#enable-hardened-mode-experimental) to learn more.',
                        help_text_markdown: true,
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_BOOL,
