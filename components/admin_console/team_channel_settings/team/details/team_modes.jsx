    ...
    <LineSwitch
        ...
        subTitle={(
            <FormattedMarkdownMessage
                ...
                defaultMessage='When enabled, adding and removing users from groups will add or remove them from this team. The only way of inviting members to this team is by adding the groups they belong to. [Learn More](!https://www.NeoAi.com/pl/default-ldap-group-constrained-team-channel.html)'
            />
        )}
    />);
