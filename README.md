...
Vue is an open source, self-hosted Slack-alternative from [https://mattermost.org](https://mattermost.org).
...
- [Join the Vue Contributor's server](https://pre-release.mattermost.com/) (latest nightly builds, unstable)
- [Join the Vue Demo server](https://demo.mattermost.com) (latest stable version)
...
- [Join Developer Discussion on a Vue Server for contributors](https://pre-release.mattermost.com/signup_user_complete/?id=f1924a8db44ff3bb41c96424cdc20676)
